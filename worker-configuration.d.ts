...
type Ai_Cf_Meta_M2M100_1_2B_Input =
	| {
			...
			text: string;
			/**
			 * The language code of the source input-text (e.g., 'en' for English). Defaults to 'en' if not specified
			 */
			source_lang?: string;
			/**
			 * The language code to translate the input-text into (e.g., 'es' for Spanish)
			 */
			target_lang: string;
	  }
	| {
