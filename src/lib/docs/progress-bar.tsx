...
const doc: ComponentDoc = {
    ...
    props: [
        { name: "aria-valuenow", type: "number", required: true, description: "Gjeldende fremgangsverdi." },
        { name: "aria-valuemin", type: "number", required: false, default: "0", description: "Minimumsverdi." },
        { name: "aria-valuemax", type: "number", required: false, default: "100", description: "Maksimumsverdi." },
        { name: "title", type: "string", required: false, default: '"Fremdrift"', description: "Synlig tittel over fremdriftslinjen." },
        { name: "aria-valuetext", type: "string", required: false, description: "Menneskelig lesbar verdi for skjermlesere." },
    ],
    examples: [
        {
