...
const doc: ComponentDoc = {
    ...
    props: [
        ...
        },
        {
            ...
            required: false,
            source: "custom",
            description: "Ikon som vises til venstre for teksten i MenuItem.",
        },
        {
            name: "as (MenuItem)",
            type: "ElementType",
            ...
            source: "custom",
            default: '"button"',
            description: "Polymorfisk prop for å endre underliggende element (f.eks. 'a' for lenker).",
        },
        {
            name: "expandable (MenuItem)",
            type: "boolean",
            required: false,
            source: "custom",
            description: "Viser et ekspanderingsikon i MenuItem.",
        },
    ],
    examples: [
        {
