    ...
    subComponents: [
        {
            ...
            props: [
                { name: "asChild", type: "boolean", required: false, source: "custom", default: "false", description: "Merger trigger-props inn i child-elementet i stedet for å wrappe det i en knapp." },
                { name: "children", type: "React.ReactNode", required: true, source: "react", description: "Innholdet i trigger-elementet." },
            ],
        },
        {
            ...
            props: [
                { name: "padding", type: '"s" | "m" | "l"', required: false, source: "custom", default: '"m"', description: "Innvendig padding i innholdsområdet." },
                { name: "initialFocus", type: "React.RefObject<HTMLElement>", required: false, source: "custom", description: "Elementet som får fokus når popoveren åpnes." },
                { name: "returnFocus", type: "React.RefObject<HTMLElement>", required: false, source: "custom", description: "Elementet som får fokus når popoveren lukkes." },
                { name: "children", type: "React.ReactNode", required: false, source: "react", description: "Innholdet i popoveren." },
            ],
        },
    ],
    examples: [
