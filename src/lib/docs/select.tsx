...
const doc: ComponentDoc = {
    ...
    props: [
        ...
        { name: "onChange", type: "(value: string | undefined) => void", required: false, source: "react", description: "Kalles ved valg." },
        ...
        { name: "searchable", type: "boolean", required: false, source: "custom", description: "Gjør nedtrekksmenyen søkbar." },
    ],
    examples: [
        {
