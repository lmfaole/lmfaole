/**
 * Typography token data for the typography foundational post.
 *
 ...
 * foundational post can source data from a single location.
 */
export {
  fontSizeSteps,
  namedStyles,
  weightSteps,
  lineHeightSteps,
} from "@/features/foundational/components/TypographyScaleDemo/typography-scale.data";
